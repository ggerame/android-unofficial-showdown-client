...
url_js_file = "https://play.pokemonshowdown.com/data/text.js"
...
for text_entry in properties:
    ...
    if vtype == 'Literal':
        texts[name] = text_entry['value']['value']
    elif vtype == 'ObjectExpression':
        texts[name] = dict()
        for sub_entry in text_entry['value']['properties']:
            # Nested format-specific descriptions are not battle message templates.
            if sub_entry['value']['type'] == 'Literal':
